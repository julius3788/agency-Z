...
const workData= [
    {
        ...
        desctiption: 'We turn bold ideas into powerful digital solutions that connect, engage...',
        image: assets.work_mobile_app
    },
    {
        title: 'Dashboard management',
        desctiption: 'We help you execute your plan and deliver results.',
        image: assets.work_dashboard_management
    },
    {
        title: 'Fitness app promotion',
        desctiption: 'We help you create a marketing strategy that drives results.',
    ...
    <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl'>
        {
            workData.map((work, index)=>(
                ...
                key={index} className='hover:scale-102 duration-500 transition-all cursor-pointer'>
                    ...
                    <p className='text-sm opacity-60 w-5/6'>{work.desctiption}</p>
                </motion.div>  
            ))
        }
